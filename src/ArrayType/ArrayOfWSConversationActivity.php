 ...
 * @subpackage Arrays
 */
class ArrayOfWSConversationActivity extends AbstractStructArrayBase
{
    /**
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \StructType\WSConversationActivity[]
     */
    public $WSConversationActivity;
    /**
     * Constructor method for ArrayOfWSConversationActivity
     * @uses ArrayOfWSConversationActivity::setWSConversationActivity()
     * @param \StructType\WSConversationActivity[] $wSConversationActivity
     */
     ...
     * @return \StructType\WSConversationActivity[]|null
     */
     ...
     * @param \StructType\WSConversationActivity[] $wSConversationActivity
     * @return \ArrayType\ArrayOfWSConversationActivity
     */
    public function setWSConversationActivity(array $wSConversationActivity = array())
    {
        foreach ($wSConversationActivity as $arrayOfWSConversationActivityWSConversationActivityItem) {
            ...
            if (!$arrayOfWSConversationActivityWSConversationActivityItem instanceof \StructType\WSConversationActivity) {
                throw new \InvalidArgumentException(sprintf('The WSConversationActivity property can only contain items of \StructType\WSConversationActivity, "%s" given', is_object($arrayOfWSConversationActivityWSConversationActivityItem) ? get_class($arrayOfWSConversationActivityWSConversationActivityItem) : gettype($arrayOfWSConversationActivityWSConversationActivityItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \StructType\WSConversationActivity $item
     * @return \ArrayType\ArrayOfWSConversationActivity
     */
    public function addToWSConversationActivity(\StructType\WSConversationActivity $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\WSConversationActivity) {
            throw new \InvalidArgumentException(sprintf('The WSConversationActivity property can only contain items of \StructType\WSConversationActivity, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }

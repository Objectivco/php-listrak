...
class Unsubscribe extends AbstractSoapClientBase
{
    ...
    /**
     * Method to call the operation originally named UnsubscribeContact
     * Meta informations extracted from the WSDL
     * - SOAPHeaderNames: WSUser
     * - SOAPHeaderNamespaces: http://webservices.listrak.com/v31/
     * - SOAPHeaderTypes: \StructType\WSUser
     * - SOAPHeaders: required
     * - documentation: Attempts to remove a contact from the specified list.
     * @uses AbstractSoapClientBase::getSoapClient()
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \StructType\UnsubscribeContact $parameters
     * @return \StructType\UnsubscribeContactResponse|bool
     */
    public function UnsubscribeContact(\StructType\UnsubscribeContact $parameters)
    {
        try {
            $this->setResult(self::getSoapClient()->UnsubscribeContact($parameters));

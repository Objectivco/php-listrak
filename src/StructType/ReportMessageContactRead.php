...
/**
 * This class stands for ReportMessageContactRead StructType
 * @subpackage Structs
 */
class ReportMessageContactRead extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageContactRead
     * @uses ReportMessageContactRead::setMsgID()
     * @uses ReportMessageContactRead::setPage()
     * @uses ReportMessageContactRead::setWSException()
     * @param int $msgID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageContactRead
     */

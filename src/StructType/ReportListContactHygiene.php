...
/**
 * This class stands for ReportListContactHygiene StructType
 * @subpackage Structs
 */
class ReportListContactHygiene extends AbstractStructBase
{
    /**
     * The ListID
    ...
    public $WSException;
    /**
     * Constructor method for ReportListContactHygiene
     * @uses ReportListContactHygiene::setListID()
     * @uses ReportListContactHygiene::setPage()
     * @uses ReportListContactHygiene::setWSException()
     * @param int $listID
     * @param int $page
     ...
     * Set ListID value
     * @param int $listID
     * @return \StructType\ReportListContactHygiene
     */

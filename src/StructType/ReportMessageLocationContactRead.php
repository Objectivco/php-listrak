...
/**
 * This class stands for ReportMessageLocationContactRead StructType
 * @subpackage Structs
 */
class ReportMessageLocationContactRead extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageLocationContactRead
     * @uses ReportMessageLocationContactRead::setMsgID()
     * @uses ReportMessageLocationContactRead::setCountryID()
     * @uses ReportMessageLocationContactRead::setPage()
     * @uses ReportMessageLocationContactRead::setWSException()
     * @param int $msgID
     * @param int $countryID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageLocationContactRead
     */

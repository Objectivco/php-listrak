 ...
 * @subpackage Structs
 */
class BulkLoadContactsWithOptions extends AbstractStructBase
{
    /**
     * The ListID
     ...
     * - minOccurs: 1
     * - nillable: true
     * @var \StructType\WSBulkLoadOptions
     */
     ...
     * @uses BulkLoadContactsWithOptions::setListID()
     * @uses BulkLoadContactsWithOptions::setWSImportDirectives()
     * @uses BulkLoadContactsWithOptions::setWSBulkLoadOptions()
     * @uses BulkLoadContactsWithOptions::setFileMappings()
     * @uses BulkLoadContactsWithOptions::setImportFileStream()
     * @param int $listID
     * @param \StructType\WSImportDirectives $wSImportDirectives
     * @param \StructType\WSBulkLoadOptions $wSBulkLoadOptions
     * @param \ArrayType\ArrayOfWSFileMappings $fileMappings
     * @param string $importFileStream
     */
    public function __construct($listID = null, \StructType\WSImportDirectives $wSImportDirectives = null, \StructType\WSBulkLoadOptions $wSBulkLoadOptions = null, \ArrayType\ArrayOfWSFileMappings $fileMappings = null, $importFileStream = null)
    {
        $this
            ->setListID($listID)
     ...
     * Set ListID value
     * @param int $listID
     * @return \StructType\BulkLoadContactsWithOptions
     */
     ...
     * @return \StructType\WSBulkLoadOptions
     */
     ...
     * @return \StructType\BulkLoadContactsWithOptions
     */
    public function setWSBulkLoadOptions(\StructType\WSBulkLoadOptions $wSBulkLoadOptions = null)
    {

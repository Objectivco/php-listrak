...
/**
 * This class stands for ReportConversationContactOpen StructType
 * @subpackage Structs
 */
class ReportConversationContactOpen extends AbstractStructBase
{
    /**
     * The ConversationID
    ...
    public $WSException;
    /**
     * Constructor method for ReportConversationContactOpen
     * @uses ReportConversationContactOpen::setConversationID()
     * @uses ReportConversationContactOpen::setPage()
     * @uses ReportConversationContactOpen::setStartDate()
     * @uses ReportConversationContactOpen::setEndDate()
     * @uses ReportConversationContactOpen::setWSException()
     ...
     * @param int $conversationID
     * @return \StructType\ReportConversationContactOpen
     */

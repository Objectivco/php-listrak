...
/**
 * This class stands for UpdateProfileHeader StructType
 * @subpackage Structs
 */
class UpdateProfileHeader extends AbstractStructBase
{
    /**
     * The WSProfileHeader
    ...
    public $WSException;
    /**
     * Constructor method for UpdateProfileHeader
     * @uses UpdateProfileHeader::setWSProfileHeader()
     * @uses UpdateProfileHeader::setWSException()
     ...
     * @param \StructType\WSProfileHeader $wSProfileHeader
     * @return \StructType\UpdateProfileHeader
     */

...
/**
 * This class stands for ReportListMessageDelivery StructType
 * @subpackage Structs
 */
class ReportListMessageDelivery extends AbstractStructBase
{
    /**
     * The ListID
    ...
    public $WSException;
    /**
     * Constructor method for ReportListMessageDelivery
     * @uses ReportListMessageDelivery::setListID()
     * @uses ReportListMessageDelivery::setStartDate()
     * @uses ReportListMessageDelivery::setEndDate()
     * @uses ReportListMessageDelivery::setIncludeTestMessages()
     * @uses ReportListMessageDelivery::setWSException()
     * @param int $listID
     ...
     * Set ListID value
     * @param int $listID
     * @return \StructType\ReportListMessageDelivery
     */

...
/**
 * This class stands for GetContactList StructType
 * @subpackage Structs
 */
class GetContactList extends AbstractStructBase
{
    /**
     * The ListID
    ...
    public $ListID;
    /**
     * Constructor method for GetContactList
     * @uses GetContactList::setListID()
     * @param int $listID
     */
     ...
     * Set ListID value
     * @param int $listID
     * @return \StructType\GetContactList
     */

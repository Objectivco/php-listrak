 ...
 * @subpackage Structs
 */
class GetProfileHeaderCollection extends AbstractStructBase
{
    /**
     * The ListID
     ...
     * @uses GetProfileHeaderCollection::setListID()
     * @uses GetProfileHeaderCollection::setWSException()
     * @param int $listID
     * @param \StructType\WSException $wSException
     */
    public function __construct($listID = null, \StructType\WSException $wSException = null)
    {
        $this
            ->setListID($listID)
     ...
     * Set ListID value
     * @param int $listID
     * @return \StructType\GetProfileHeaderCollection
     */

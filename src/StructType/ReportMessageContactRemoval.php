...
/**
 * This class stands for ReportMessageContactRemoval StructType
 * @subpackage Structs
 */
class ReportMessageContactRemoval extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageContactRemoval
     * @uses ReportMessageContactRemoval::setMsgID()
     * @uses ReportMessageContactRemoval::setPage()
     * @uses ReportMessageContactRemoval::setWSException()
     * @param int $msgID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageContactRemoval
     */

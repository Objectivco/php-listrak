...
/**
 * This class stands for ReportMessageContactBounces StructType
 * @subpackage Structs
 */
class ReportMessageContactBounces extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageContactBounces
     * @uses ReportMessageContactBounces::setMsgID()
     * @uses ReportMessageContactBounces::setPage()
     * @uses ReportMessageContactBounces::setWSException()
     * @param int $msgID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageContactBounces
     */

...
/**
 * This class stands for DeleteContactList StructType
 * @subpackage Structs
 */
class DeleteContactList extends AbstractStructBase
{
    /**
     * The ListID
    ...
    public $ListID;
    /**
     * Constructor method for DeleteContactList
     * @uses DeleteContactList::setListID()
     * @param int $listID
     */
     ...
     * Set ListID value
     * @param int $listID
     * @return \StructType\DeleteContactList
     */

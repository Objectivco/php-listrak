...
/**
 * This class stands for ReportMessageLocationRead StructType
 * @subpackage Structs
 */
class ReportMessageLocationRead extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageLocationRead
     * @uses ReportMessageLocationRead::setMsgID()
     * @uses ReportMessageLocationRead::setPage()
     * @uses ReportMessageLocationRead::setWSException()
     * @param int $msgID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageLocationRead
     */

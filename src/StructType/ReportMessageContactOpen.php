...
/**
 * This class stands for ReportMessageContactOpen StructType
 * @subpackage Structs
 */
class ReportMessageContactOpen extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageContactOpen
     * @uses ReportMessageContactOpen::setMsgID()
     * @uses ReportMessageContactOpen::setPage()
     * @uses ReportMessageContactOpen::setWSException()
     * @param int $msgID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageContactOpen
     */

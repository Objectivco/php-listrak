...
/**
 * This class stands for WSBulkLoadOptions StructType
 * @subpackage Structs
 */
class WSBulkLoadOptions extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for WSBulkLoadOptions
     * @uses WSBulkLoadOptions::setSuppressEmailNotifications()

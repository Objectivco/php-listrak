...
/**
 * This class stands for ReportMessageLocationContactClick StructType
 * @subpackage Structs
 */
class ReportMessageLocationContactClick extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageLocationContactClick
     * @uses ReportMessageLocationContactClick::setMsgID()
     * @uses ReportMessageLocationContactClick::setCountryID()
     * @uses ReportMessageLocationContactClick::setPage()
     * @uses ReportMessageLocationContactClick::setWSException()
     * @param int $msgID
     * @param int $countryID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageLocationContactClick
     */

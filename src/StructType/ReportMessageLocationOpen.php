...
/**
 * This class stands for ReportMessageLocationOpen StructType
 * @subpackage Structs
 */
class ReportMessageLocationOpen extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageLocationOpen
     * @uses ReportMessageLocationOpen::setMsgID()
     * @uses ReportMessageLocationOpen::setPage()
     * @uses ReportMessageLocationOpen::setWSException()
     * @param int $msgID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageLocationOpen
     */

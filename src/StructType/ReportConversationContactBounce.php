...
/**
 * This class stands for ReportConversationContactBounce StructType
 * @subpackage Structs
 */
class ReportConversationContactBounce extends AbstractStructBase
{
    /**
     * The ConversationID
    ...
    public $WSException;
    /**
     * Constructor method for ReportConversationContactBounce
     * @uses ReportConversationContactBounce::setConversationID()
     * @uses ReportConversationContactBounce::setPage()
     * @uses ReportConversationContactBounce::setStartDate()
     * @uses ReportConversationContactBounce::setEndDate()
     * @uses ReportConversationContactBounce::setWSException()
     ...
     * @param int $conversationID
     * @return \StructType\ReportConversationContactBounce
     */

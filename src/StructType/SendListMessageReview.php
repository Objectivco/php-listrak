...
/**
 * This class stands for SendListMessageReview StructType
 * @subpackage Structs
 */
class SendListMessageReview extends AbstractStructBase
{
    /**
     * The WSMessage
    ...
    public $WSMessage;
    /**
     * Constructor method for SendListMessageReview
     * @uses SendListMessageReview::setWSMessage()
     ...
     * Set WSMessage value
     * @param \StructType\WSMessage $wSMessage
     * @return \StructType\SendListMessageReview
     */

...
/**
 * This class stands for ReportMessageContactClick StructType
 * @subpackage Structs
 */
class ReportMessageContactClick extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageContactClick
     * @uses ReportMessageContactClick::setMsgID()
     * @uses ReportMessageContactClick::setPage()
     * @uses ReportMessageContactClick::setWSException()
     * @param int $msgID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageContactClick
     */

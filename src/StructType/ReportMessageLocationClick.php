...
/**
 * This class stands for ReportMessageLocationClick StructType
 * @subpackage Structs
 */
class ReportMessageLocationClick extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageLocationClick
     * @uses ReportMessageLocationClick::setMsgID()
     * @uses ReportMessageLocationClick::setPage()
     * @uses ReportMessageLocationClick::setWSException()
     * @param int $msgID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageLocationClick
     */

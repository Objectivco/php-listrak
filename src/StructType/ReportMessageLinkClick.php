...
/**
 * This class stands for ReportMessageLinkClick StructType
 * @subpackage Structs
 */
class ReportMessageLinkClick extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageLinkClick
     * @uses ReportMessageLinkClick::setMsgID()
     * @uses ReportMessageLinkClick::setPage()
     * @uses ReportMessageLinkClick::setWSException()
     * @param int $msgID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageLinkClick
     */

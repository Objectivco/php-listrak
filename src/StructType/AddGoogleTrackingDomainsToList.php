...
/**
 * This class stands for AddGoogleTrackingDomainsToList StructType
 * @subpackage Structs
 */
class AddGoogleTrackingDomainsToList extends AbstractStructBase
{
    /**
     * The ListID
    ...
    /**
     * Constructor method for AddGoogleTrackingDomainsToList
     * @uses AddGoogleTrackingDomainsToList::setListID()
     * @uses AddGoogleTrackingDomainsToList::setGoogleTrackingDomains()
     * @param int $listID
     ...
     * Set ListID value
     * @param int $listID
     * @return \StructType\AddGoogleTrackingDomainsToList
     */

...
/**
 * This class stands for GetCampaignCollection StructType
 * @subpackage Structs
 */
class GetCampaignCollection extends AbstractStructBase
{
    /**
     * The ListID
    ...
    public $ListID;
    /**
     * Constructor method for GetCampaignCollection
     * @uses GetCampaignCollection::setListID()
     * @param int $listID
     */
     ...
     * Set ListID value
     * @param int $listID
     * @return \StructType\GetCampaignCollection
     */

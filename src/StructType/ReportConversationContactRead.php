...
/**
 * This class stands for ReportConversationContactRead StructType
 * @subpackage Structs
 */
class ReportConversationContactRead extends AbstractStructBase
{
    /**
     * The ConversationID
    ...
    public $WSException;
    /**
     * Constructor method for ReportConversationContactRead
     * @uses ReportConversationContactRead::setConversationID()
     * @uses ReportConversationContactRead::setPage()
     * @uses ReportConversationContactRead::setStartDate()
     * @uses ReportConversationContactRead::setEndDate()
     * @uses ReportConversationContactRead::setWSException()
     ...
     * @param int $conversationID
     * @return \StructType\ReportConversationContactRead
     */

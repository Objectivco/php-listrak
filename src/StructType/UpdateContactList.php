...
/**
 * This class stands for UpdateContactList StructType
 * @subpackage Structs
 */
class UpdateContactList extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for UpdateContactList
     * @uses UpdateContactList::setWSUpdateContactList()
     ...
     * @param \StructType\WSUpdateContactList $wSUpdateContactList
     * @return \StructType\UpdateContactList
     */

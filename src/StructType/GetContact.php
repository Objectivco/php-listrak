...
/**
 * This class stands for GetContact StructType
 * @subpackage Structs
 */
class GetContact extends AbstractStructBase
{
    /**
     * The ListID
    ...
    /**
     * Constructor method for GetContact
     * @uses GetContact::setListID()
     * @uses GetContact::setContactEmailAddress()
     * @param int $listID

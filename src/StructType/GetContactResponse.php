...
/**
 * This class stands for GetContactResponse StructType
 * @subpackage Structs
 */
class GetContactResponse extends AbstractStructBase
{
    /**
     * The WSContact
    ...
    public $WSContact;
    /**
     * Constructor method for GetContactResponse
     * @uses GetContactResponse::setWSContact()
     ...
     * Set WSContact value
     * @param \StructType\WSContact $wSContact
     * @return \StructType\GetContactResponse
     */

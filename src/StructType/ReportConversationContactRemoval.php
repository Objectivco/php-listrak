...
/**
 * This class stands for ReportConversationContactRemoval StructType
 * @subpackage Structs
 */
class ReportConversationContactRemoval extends AbstractStructBase
{
    /**
     * The ConversationID
    ...
    public $WSException;
    /**
     * Constructor method for ReportConversationContactRemoval
     * @uses ReportConversationContactRemoval::setConversationID()
     * @uses ReportConversationContactRemoval::setPage()
     * @uses ReportConversationContactRemoval::setStartDate()
     * @uses ReportConversationContactRemoval::setEndDate()
     * @uses ReportConversationContactRemoval::setWSException()
     ...
     * @param int $conversationID
     * @return \StructType\ReportConversationContactRemoval
     */

...
/**
 * This class stands for ReportListConversationActivity StructType
 * @subpackage Structs
 */
class ReportListConversationActivity extends AbstractStructBase
{
    /**
     * The ListID
    ...
    public $WSException;
    /**
     * Constructor method for ReportListConversationActivity
     * @uses ReportListConversationActivity::setListID()
     * @uses ReportListConversationActivity::setIncludeTerminated()
     * @uses ReportListConversationActivity::setWSException()
     * @param int $listID
     ...
     * Set ListID value
     * @param int $listID
     * @return \StructType\ReportListConversationActivity
     */

...
/**
 * This class stands for ReportMessageContactActivity StructType
 * @subpackage Structs
 */
class ReportMessageContactActivity extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageContactActivity
     * @uses ReportMessageContactActivity::setMsgID()
     * @uses ReportMessageContactActivity::setPage()
     * @uses ReportMessageContactActivity::setWSException()
     * @param int $msgID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageContactActivity
     */

...
/**
 * This class stands for WSUpdateSubcribedContactAttributeOptions StructType
 * @subpackage Structs
 */
class WSUpdateSubcribedContactAttributeOptions extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for WSUpdateSubcribedContactAttributeOptions
     * @uses WSUpdateSubcribedContactAttributeOptions::setSuppressEmailNotifications()

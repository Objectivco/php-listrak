...
/**
 * This class stands for ReportListContactRemoval StructType
 * @subpackage Structs
 */
class ReportListContactRemoval extends AbstractStructBase
{
    /**
     * The ListID
    ...
    public $WSException;
    /**
     * Constructor method for ReportListContactRemoval
     * @uses ReportListContactRemoval::setListID()
     * @uses ReportListContactRemoval::setPage()
     * @uses ReportListContactRemoval::setWSException()
     * @param int $listID
     * @param int $page
     ...
     * Set ListID value
     * @param int $listID
     * @return \StructType\ReportListContactRemoval
     */

...
/**
 * This class stands for ReportConversationLocationContactClick StructType
 * @subpackage Structs
 */
class ReportConversationLocationContactClick extends AbstractStructBase
{
    /**
     * The ConversationID
    ...
    public $WSException;
    /**
     * Constructor method for ReportConversationLocationContactClick
     * @uses ReportConversationLocationContactClick::setConversationID()
     * @uses ReportConversationLocationContactClick::setGeoLocationID()
     * @uses ReportConversationLocationContactClick::setPage()
     * @uses ReportConversationLocationContactClick::setStartDate()
     * @uses ReportConversationLocationContactClick::setEndDate()
     * @uses ReportConversationLocationContactClick::setWSException()
     ...
     * @param int $conversationID
     * @return \StructType\ReportConversationLocationContactClick
     */

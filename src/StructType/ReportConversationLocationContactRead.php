...
/**
 * This class stands for ReportConversationLocationContactRead StructType
 * @subpackage Structs
 */
class ReportConversationLocationContactRead extends AbstractStructBase
{
    /**
     * The ConversationID
    ...
    public $WSException;
    /**
     * Constructor method for ReportConversationLocationContactRead
     * @uses ReportConversationLocationContactRead::setConversationID()
     * @uses ReportConversationLocationContactRead::setGeoLocationID()
     * @uses ReportConversationLocationContactRead::setPage()
     * @uses ReportConversationLocationContactRead::setStartDate()
     * @uses ReportConversationLocationContactRead::setEndDate()
     * @uses ReportConversationLocationContactRead::setWSException()
     ...
     * @param int $conversationID
     * @return \StructType\ReportConversationLocationContactRead
     */

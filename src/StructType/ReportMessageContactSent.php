...
/**
 * This class stands for ReportMessageContactSent StructType
 * @subpackage Structs
 */
class ReportMessageContactSent extends AbstractStructBase
{
    /**
     * The MsgID
    ...
    public $WSException;
    /**
     * Constructor method for ReportMessageContactSent
     * @uses ReportMessageContactSent::setMsgID()
     * @uses ReportMessageContactSent::setPage()
     * @uses ReportMessageContactSent::setWSException()
     * @param int $msgID
     * @param int $page
     ...
     * Set MsgID value
     * @param int $msgID
     * @return \StructType\ReportMessageContactSent
     */
